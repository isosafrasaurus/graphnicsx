...
def _point_values_on_vertices(func: dolfinx.fem.Function, vertex_coords: np.ndarray, cell_of_vertex: np.ndarray) -> np.ndarray:
...
def _radius_values_on_vertices(G: FenicsGraph, used_vertices: np.ndarray, cell_of_vertex: np.ndarray, cell_to_edge: np.ndarray) -> np.ndarray:
